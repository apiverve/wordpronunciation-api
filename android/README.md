# Word Pronunciation Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:wordpronunciation-api:1.1.13'
}
```
...
```java
import com.apiverve.wordpronunciation.WordPronunciationAPIClient;
import com.apiverve.wordpronunciation.APIResponse;
import com.apiverve.wordpronunciation.APIException;

// Initialize the client
WordPronunciationAPIClient client = new WordPronunciationAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("word", "hello");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/wordpronunciation](https://docs.apiverve.com/ref/wordpronunciation)
...
- **Documentation:** [https://docs.apiverve.com/ref/wordpronunciation](https://docs.apiverve.com/ref/wordpronunciation)
- **Issues:** [GitHub Issues](https://github.com/apiverve/wordpronunciation-api/issues)
