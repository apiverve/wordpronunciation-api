...
namespace APIVerve.API.WordPronunciation
{
    ...
    /// <summary>
    /// Client for the WordPronunciation API
    /// </summary>
    public class WordPronunciationAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/wordpronunciation";
        ...
        public WordPronunciationAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WordPronunciationAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WordPronunciationAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, WordPronunciationQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(WordPronunciationQueryOptions options)
        {
        ...
        public ResponseObj Execute(WordPronunciationQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(WordPronunciationQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(WordPronunciationQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(WordPronunciationQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(WordPronunciationQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(WordPronunciationQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(WordPronunciationQueryOptions options)
        {
