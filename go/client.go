// Package wordpronunciation provides a Go client for the Word Pronunciation API.
//
// For more information, visit: https://apiverve.com/marketplace/wordpronunciation?utm_source=go&utm_medium=readme
package wordpronunciation
...
const (
	baseURL        = "https://api.apiverve.com/v1/wordpronunciation"
	defaultTimeout = 30 * time.Second
)

// Client is the Word Pronunciation API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Word Pronunciation API client.
...
// Execute makes a request to the Word Pronunciation API with typed parameters.
//
...
//   - word (required): string - The word to get the pronunciation of
